...
class Attendance:
    ...
    def __init__(self,root):
        ...
        self.root.title("Hệ thống điểm danh trường ĐH TN&MT Hà Nội.")
        ...
        # ====title=========
        self.txt = "Quản lý thông tin điểm danh sinh viên"
        self.count = 0
        self.text = ''
    ...
    def update_data(self):
        if self.var_atten_lesson.get()=="Lesson" or self.var_atten_attendance.get()=="Status" or self.var_atten_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host='localhost', user='root', password='', database='face_recognizer', port='3308')
                    my_cursor = conn.cursor()
                ...
                try:
                    ...
                    if delete > 0:
                        conn = mysql.connector.connect(host='localhost', user='root', password='',
                                                       database='face_recognizer', port='3308')
                        my_cursor = conn.cursor()
